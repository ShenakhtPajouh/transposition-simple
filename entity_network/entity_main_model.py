...
class entity_main_model(keras.Model):
    ...
    def __init__(self, name, entity_num, entity_embedding_dim, rnn_hidden_size,
                 max_sent_num, determiner_dropout_rate):
        ...
        self._entity_cell = EntityCell(
            max_entity_num=entity_num,
            entity_embedding_dim=entity_embedding_dim,
            name='entity_cell')
        self._determiner = Determiner(self._name + "/determiner",
                                      output_size=2,
                                      hidden_dim=64,

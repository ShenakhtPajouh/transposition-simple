...
def batch_generator(paragraphs , batch_size , max_sent , bert_vocab_path):
    """
    ...
    :param max_sent: maximum number that could be in a paragraph
    """
    ...
    for i in range(0, len(paragraphs), batch_size):
        ...
        inputs = np.zeros((num_sents , max_sent) , dtype=np.int32)
        sentence_mask = np.zeros((num_sents , max_sent) , dtype=np.int32)
